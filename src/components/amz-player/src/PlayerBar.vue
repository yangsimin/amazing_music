 ...
 * @LastEditTime: 2022-03-20 23:37:06
 * @LastEditors: simonyang
 * @Description: 
-->
<template>
  <div class="player-bar w-full">
    <player-progress-bar class="md:hidden"></player-progress-bar>
    <div class="flex items-center h-20" @click.prevent="takeAction">
      <!-- 单曲循环/列表循环/随机播放 -->
      <i
      ...
      <player-progress-bar
        class="hidden md:block md:flex-1 md:px-10"
      ></player-progress-bar>
      <div class="flex">
        <!-- 音量 -->
        <i
        ...
        <!-- 播放列表 -->
        <i
          class="iconfont flex-1 icon-playlist pr-10 cursor-pointer media:hover:amz-text-hl before:text-2xl"
